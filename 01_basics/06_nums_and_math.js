...
//***********Maths*************/
 ...
 console.log(Math.abs(-4)); // to convert a neg value to positive
 console.log(Math.round(4.3) );// round off according to <5>
 console.log(Math.ceil(4.2));// round off only accordin to >5
 console.log(Math.floor(4.9));// round off only accordin to <5
